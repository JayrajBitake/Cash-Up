...
import com.cashup.model.AuthRequestModel;
import com.cashup.model.AuthResponseModel;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticate(@RequestBody @Valid AuthRequestModel input) {
		...
		authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(input.getUname(), input.getPass()));
		
		
		String jwt =  Jwts.builder()
				.setSubject(input.getUname())
				.setIssuer("cdac")
